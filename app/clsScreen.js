/* Intended to handle different screens for a fitbit clock-face.
   ...
   allow to loop forward and backward through the screens
    ...
    methods:  - nextScreen: goes upward one screen (activescren), loops to first screen after last
              - prevScreen: goes downward one screen (activescren), loops to last screen after first
